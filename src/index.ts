...
export type WEBHOOK_EVENTS = {
    ...
    installation: S[Exclude<("webhook-installation" | `webhook-installation-${string}`) & keyof S, `webhook-installation-repositories${string}` | `webhook-installation-target${string}`>];
    ...
    project: S[Exclude<("webhook-project" | `webhook-project-${string}`) & keyof S, `webhook-project-card${string}` | `webhook-project-column${string}`>];
    ...
    pull_request: S[Exclude<("webhook-pull-request" | `webhook-pull-request-${string}`) & keyof S, `webhook-pull-request-review${string}`>];
    pull_request_review: S[Exclude<("webhook-pull-request-review" | `webhook-pull-request-review-${string}`) & keyof S, `webhook-pull-request-review-comment${string}` | `webhook-pull-request-review-thread${string}`>];
    ...
    repository: S[Exclude<("webhook-repository" | `webhook-repository-${string}`) & keyof S, `webhook-repository-advisory${string}` | `webhook-repository-dispatch${string}` | `webhook-repository-import${string}` | `webhook-repository-ruleset${string}` | `webhook-repository-vulnerability-alert${string}`>];
    ...
    secret_scanning_alert: S[Exclude<("webhook-secret-scanning-alert" | `webhook-secret-scanning-alert-${string}`) & keyof S, `webhook-secret-scanning-alert-location${string}`>];
